...
def vendor_consumption_analysis(df):
    ...
    # Use Plotly Chart to Visualize
    return {
        'fig_vendor': fig_vendor.to_json(),
        'fig_vendor_time_series': fig_vendor_time_series.to_json(),
    }
...
def location_consumption_analysis(df):
    ...
    # Use Plotly Chart to Visualize
    return {
        'fig_plant': fig_plant.to_json(),
        'fig_site': fig_site.to_json(),
    }
...
def batch_variability_analysis(df):
    ...
    # Use Plotly Chart to Visualize
    return {
        'fig_variance': fig_variance.to_json(),
    }
...
def combined_analysis(df):
    ...
    # Use Plotly Chart to Visualize
    return {
        'fig_vendor_material': fig_vendor_material.to_json(),
        'fig_site_material': fig_site_material.to_json(),
    }
