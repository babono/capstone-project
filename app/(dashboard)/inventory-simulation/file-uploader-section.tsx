...
import {
  PAGE_KEYS,
  PAGE_LABELS,
  ORDER_PLACEMENT_BUCKET_URL,
  GOODS_RECEIPT_BUCKET_URL,
  SHORTAGE_REPORT_BUCKET_URL,
  MATERIAL_CONSUMPTION_BUCKET_URL,
} from "@/app/constants";

const FileUploaderSection = ({
  handleMaterialConsumptionData,
  handleGoodsReceiptData,
  handleOrderPlacementData,
  handleShortageReportData,
}) => {
  return (
    <div>
      <FileUploader
        type={PAGE_KEYS.MATERIAL_CONSUMPTION}
        title={PAGE_LABELS.MATERIAL_CONSUMPTION}
        fileBucketURL={MATERIAL_CONSUMPTION_BUCKET_URL}
        onDataRetrieved={handleMaterialConsumptionData}
      />
      <FileUploader
